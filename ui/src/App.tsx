...
import { AgentLogos } from "./pages/AgentLogos";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="company/settings/logos" element={<AgentLogos />} />
      ...
      <Route path="issues/archive" element={<IssuesArchive />} />
      ...
      <Route path="inbox/matters" element={<Inbox />} />
      <Route path="inbox/split" element={<Inbox />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="experience-board" element={<UnprefixedBoardRedirect />} />
