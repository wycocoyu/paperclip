...
import { workspaceExperienceBoardRoutes } from "./routes/workspace-experience-board.js";
import { workspaceRememberRoutes } from "./routes/workspace-remember.js";
import { workspaceRulesRoutes } from "./routes/workspace-rules.js";
...
app.use("/api/auth", authRoutes(db));
  ...
  api.use(teamWikiRoutes(db));
  api.use(openspecRoutes());
  api.use(workspaceRulesRoutes(db));
  api.use(workspaceExperienceBoardRoutes(db));
  api.use(workspaceRememberRoutes(db));
